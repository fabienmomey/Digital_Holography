...
EXPE.real_constraint = [0.0,0.0];   % a 2-element vector 
                                    % giving hard constraint parameter for 
                                    % the real part of the transmittance
EXPE.imag_constraint = [0.0,Inf];   % a 2-element vector 
                                    % giving hard constraint parameter for 
                                    % the imag part of the transmittance
