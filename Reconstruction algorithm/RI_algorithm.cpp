...
///
/// \file RI_algorithm.cpp
/// 
/// \author Yoann MASSET - Fabien MOMEY
/// \version Final version
/// \date June 20th 2020
/// 
/// \brief Main file for reconstruction with the regularized inversion method (FISTA)
/// 
...
int main(int argc, char* argv[])
{
    ...
    //Hologram reconstruction with the regularized inversion method (FISTA)-------------------------------------------------------------------------------------------------------------------------------------------
    ...
    if (argc >= 10)
    {
        ...
        string logpath = "output/log/RI_" + dest_files + ".txt"; //The path to the log file
        output.open(logpath, ios::out); //Open the log file to write the state of the program
        output << "---------- Start - Regularized inversion reconstitution (FISTA) ---------- " << endl;
