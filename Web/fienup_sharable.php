...
function loadFile() {
    ...
    if(file_exists($params)) {
        ...
        echo "<h2>Share</h2>";
        echo "<form><div class=\"form-group\"><label for=\"link\"><a target='_blank' rel='noopener noreferrer' href='fienup_download.php?value=".$_GET["value"]."'>Download files</a></label><br>";
        echo "<div class=\"form-group\"><label for=\"link\"><a target='_blank' rel='noopener noreferrer' href='contact.php?app=reconstruction_algorithm&value=".$_GET["value"]."'>Contact us</a></label><br>";
        echo "<label for=\"link\">Sharable link:</label><div class=\"col-sm-10\"><input type='text' onclick='this.select();' class='form-control' name='link' value='localhost/stage%20labo/fienup_sharable.php?value=".$_GET["value"]."'></div></div></form></p>";
    }
    else {
        echo "<p>Something went wrong. Please try again or <a href='contact.php?app=reconstruction_algorithm&value=".$_GET["value"]."'>contact us</a>.</p>";
        if(file_exists($log)) {
            $order   = array("\r\n", "\n", "\r");
...
<div class="w3-row w3-padding-32">
  ...
  <div id="myresult" class="img-zoom-result w3-half"></div>
    ...
    <button class="w3-button w3-black w3-round-xxlarge"><a href="fienup.php">Back</a></button>
...
<script src="fienup_res_controller.js"></script>
