...
set_time_limit(500);
    ...
    function runScript($filename) {
        ...
        if($validInput) {
            ...
            exec(escapeshellcmd("\"./bin/Reconstruction_algorithm\" uploads/" . $filename . " " . $destname . " " . $startz . " " . $endz . " " . $stepz . " " . $lambda . " " . $pp . " " . $zeropad));
            //Redirection vers l'affichage du résultat
            $newURL = "fienup_sharable.php?value=".$destname;
            sleep(0.1);
